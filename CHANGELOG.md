...
### Added
- Automatic detection and installation of dependencies for security-focused Linux distributions (Kali Linux and ParrotOS)
- New `install_security_distro_deps()` function to handle security distribution specific installations

### Changed
- Modified `check_deps()` function to automatically detect security distributions and install dependencies
- Updated documentation to reflect automatic installation for security distributions
